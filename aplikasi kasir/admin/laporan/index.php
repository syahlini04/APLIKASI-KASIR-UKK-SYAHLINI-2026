...
$stats = mysqli_fetch_assoc(mysqli_query($conn, "
    SELECT 
        ...
        COALESCE(MIN(total), 0) as min_transaksi,
        COALESCE(MAX(total), 0) as max_transaksi
    FROM transaksi
...
<head>
    ...
    <style>
        @media print {
            .sidebar, .topbar, .card:nth-of-type(1), .card:nth-child(1), .stats-grid > div:nth-child(1), .stats-grid > div:nth-child(2), .stats-grid > div:nth-child(3), .stats-grid > div:nth-child(4), .stats-grid > div:nth-child(5) {
                display: none;
            }
            .dashboard-wrapper {
                display: flex;
            ...
            <div class="dashboard-content">
                ...
                <div class="card" style="border: 2px solid #e2e8f0;">
                    <div class="card-header" style="background: white; color: #1e293b; border-radius: 8px 8px 0 0;">
                        <div>
                            <h3 class="card-title" style="color: #1e293b; margin: 0;">📊 Laporan Transaksi</h3>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="../transaksi/detail.php?id=<?php echo $t['transaksi_id']; ?>" style="color: #2563eb; text-decoration: none; font-size: 12px; font-weight: 600;">Lihat →</a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (filterBtn) {
                filterBtn.addEventListener('mouseenter', function() {
                    this.style.background = 'linear-gradient(135deg, #1d4ed8 0%, #1e3a8a 100%)';
                    this.style.transform = 'translateY(-2px)';
